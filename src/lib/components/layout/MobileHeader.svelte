...
<header
	class="bg-white/30 dark:bg-gray-800/30 backdrop-blur-xl -webkit-backdrop-blur-xl border-b border-white/20 dark:border-gray-700/20 p-4 flex items-center justify-between sticky top-0 z-10 shadow-lg"
>
	<div class="flex items-center">
		...
		<h2 class="text-xl font-medium text-gray-800 dark:text-gray-200">{currentTab.title}</h2>
	</div>

	{#if currentTab.action}
		<button
			class="w-10 h-10 rounded-full bg-indigo-500/90 dark:bg-indigo-600/90 backdrop-blur-sm flex items-center justify-center text-white border-none cursor-pointer shadow-md transition-all duration-200 hover:bg-indigo-600/90 dark:hover:bg-indigo-700/90 hover:shadow-lg"
